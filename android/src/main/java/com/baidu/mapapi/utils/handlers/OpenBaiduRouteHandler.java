...
public class OpenBaiduRouteHandler extends MethodChannelHandler {
        ...
        try {
            switch (openRouteOptionBean.routeType) {
                ...
                case Constants.RouteType.sTransitRoute:
                    ...
                    break;
                case Constants.RouteType.sNewEngDriveRoute:
                    ret = BaiduMapRoutePlan
                            .openBaiduMapNewEnergyRoute(routeParaOption, applicationContext);
                    break;
                case Constants.RouteType.sTruckRoute:
                    ret = BaiduMapRoutePlan
                            .openBaiduMapTruckRoute(routeParaOption, applicationContext);
                    break;
                default:
                    break;
            }
    ...
    private RouteParaOption toNaviParaOption(OpenRouteOptionBean openRouteOptionBean) {
        ...
        if (null != openRouteOptionBean.startUid) {
            routeParaOption.startPoiId(openRouteOptionBean.startUid);
        }
        if (null != openRouteOptionBean.endUid) {
            routeParaOption.endPoiId(openRouteOptionBean.endUid);
        }
